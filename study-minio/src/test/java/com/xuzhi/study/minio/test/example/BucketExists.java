...
import com.xuzhi.study.minio.config.MinioConfiguration;
  ...
  public static void main(String[] args)
    ...
    try {
      ...
      MinioClient minioClient =
          MinioClient.builder()
              .endpoint(MinioConfiguration.MinioUrl)
              .credentials(MinioConfiguration.MinioAccessKey, MinioConfiguration.MinioSecretKey)
              .build();
